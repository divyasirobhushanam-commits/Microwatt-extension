...
architecture behaviour of decode2 is
    ...
    constant result_select : mux_select_array_t := (
        ...
        OP_MFCR     => "111",
        OP_SETB     => "111",
	 -- begin custom scalar ops
        OP_CUSTOM_ADD_I8  => "110",   -- custom_result (from custom_scalar_unit)
        OP_CUSTOM_SUB_I8  => "110",
        OP_CUSTOM_FP8_ADD => "110",
        OP_CUSTOM_FP8_MUL => "110",
        -- end custom scalar ops
