...
package decode_types is
    type insn_type_t is (OP_ILLEGAL, OP_NOP, OP_ADD,
			 ...
			 OP_XOR,
                         OP_ADDG6S,
			     -- begin custom scalar instructions
                         OP_CUSTOM_ADD_I8,
                         OP_CUSTOM_SUB_I8,
                         OP_CUSTOM_FP8_ADD,
                         OP_CUSTOM_FP8_MUL,
                          -- end custom scalar instructions
                         OP_FETCH_FAILED
			 );
...
package body decode_types is
    ...
    begin
        case icode is
	     ...
	     -- Custom scalar INT8/FP8 instructions
            when INSN_CUSTOM_ADD_I8  => return "010110";  -- opcode 22
            when INSN_CUSTOM_SUB_I8  => return "010110";  -- opcode 22
            when INSN_CUSTOM_FP8_ADD => return "010110";  -- opcode 22
            when INSN_CUSTOM_FP8_MUL => return "010110";  -- opcode 22
